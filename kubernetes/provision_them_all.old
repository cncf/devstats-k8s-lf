...
PROJ=helm                   PROJDB=helm                   PROJREPO="kubernetes/helm"                 ./kubernetes/apply_manifest.sh ./kubernetes/manifests/devstats-provision.yaml || exit 37
...
PROJ=cncf                   PROJDB=cncf                   PROJREPO="cncf/landscape"                  ./kubernetes/apply_manifest.sh ./kubernetes/manifests/devstats-provision.yaml || exit 48
