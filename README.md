...
- Run `./kubernetes/apply_manifest.sh ./kubernetes/manifests/devstats-pvc.yml` to create presistent volume and persisten volume claim for git repository clones storage. This must be done first.
